...
export const FRONTEND_URL = import.meta.env.VITE_FRONTEND_URL || "https://quintilis.org"

export const AUTH_URL = `${API_URL}/api/auth`; // Direto no Auth Service (ex: /auth/register)
export const API_OAUTH2_ROUTES = `${API_URL}/oauth2`; // Endpoints OAuth2 (ex: /oauth2/token)
